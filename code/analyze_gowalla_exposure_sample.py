...
output_path = "../results/gowalla_exposure_sample_summary.txt"
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write("Gowalla LightGCN Top-20 Exposure Sample Analysis\n")
    f.write("==============================================\n\n")
    f.write("Note: This is based on the exported sample of 200 test users.\n")
    f.write("It is used only to verify the exposure-analysis pipeline.\n\n")
    ...
    f.write(f"Coverage on sample: {coverage:.6f}\n")

print("Exposure sample analysis finished.")
