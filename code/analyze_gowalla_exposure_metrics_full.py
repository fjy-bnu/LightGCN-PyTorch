...
output_path = "../results/gowalla_exposure_metrics_full.txt"
...
with open(output_path, "w", encoding="utf-8") as f:
    f.write("Gowalla LightGCN Exposure Metrics Full\n")
    f.write("====================================\n\n")

    f.write("Note: This result is based on the full exported Top-20 recommendation list.\n\n")
...
print("Full exposure metrics analysis finished.")
